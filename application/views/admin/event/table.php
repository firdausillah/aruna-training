<div class="card p-3">
    <div class="d-flex justify-content-between">
        ...
        <a href="<?= base_url('admin/event?page=add') ?>" class="btn btn-sm btn-success my-auto">Tambah data</a>
            ...
            <tbody class="table-border-bottom-0">
                <?php foreach ($event as $index => $item) : ?>
                    <tr>
                        ...
                        <td>
                            <a class="text-success" href="<?= base_url('admin/event?page=detail&id=' . $item->id) ?>"><i class="bx bx-detail me-1"></i></a>
                            <a class="text-info" href="<?= base_url('admin/event?page=edit&id=' . $item->id) ?>"><i class="bx bx-edit-alt me-1"></i></a>
                            <a class="text-danger" href="#" onclick="confirmDelete('<?= base_url('admin/event/nonaktif/' . $item->id) ?>')"><i class="bx bx-trash me-1"></i></a>
                        </td>
                    </tr>
                <?php endforeach ?>
            </tbody>
